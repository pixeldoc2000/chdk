...
void startup()
{
    ...
    void console_init()
    {
        ...
        // Write stdout.txt
        FILE *fdout = fopen("A/stdout.txt", "r");   // Write stdout.txt if file exist
        //FILE *fdout = fopen("A/stdout.txt", "a");   // Create/append stdout.txt
        if (fdout) {
