...
void __attribute__((naked,noinline)) sub_FFC15BC8_my() { //#fs 
        asm volatile (
                "STMFD   SP!, {R4,LR}\n"
                "LDR     R4, =0x1CB8\n"
                "MOV     R0, #0\n"
...
void __attribute__((naked,noinline)) sub_FFC4BDD8_my() { //#fs 
        asm volatile (
                "STMFD   SP!, {R4,LR}\n"
                "LDR     R4, =0x5630\n"
                "LDR     R0, [R4,#8]\n"
...
void __attribute__((naked,noinline)) sub_FFC4CDC0_my() { //#fs  // CreateTask_CaptSeqTask
        asm volatile (
                "STMFD   SP!, {R3-R5,LR}\n"
                "LDR     R2, =0x1921C\n"
                "MOV     R0, #0\n"
