...
//	if(p[0]==0xFF8331C4) p[0]=(int)mykbd_task;   			//done
	if(p[0]==0xFF88E52C) p[0]=(int)init_file_modules_task;	//done 
	if(p[0]==0xFF872F90) p[0]=(int)capt_seq_task;  			//done
	if(p[0]==0xFF8B2F80) p[0]=(int)exp_drv_task;			//done
	if(p[0]==0xFF93D654) p[0]=(int)movie_record_task;		//done
}
